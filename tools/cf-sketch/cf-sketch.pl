...
use lib "$FindBin::Bin/../lib/cf-sketch", "$FindBin::Bin/perl-lib",
    "$FindBin::Bin/perl-lib/File-Which-1.09/lib", "$FindBin::Bin/../lib/cf-sketch/File-Which-1.09/lib", 
    "$FindBin::Bin/perl-lib/JSON-2.53/lib", "$FindBin::Bin/../lib/cf-sketch/JSON-2.53/lib";
